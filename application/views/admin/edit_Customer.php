                                ...
                                <div class="tab-content">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo isset($pageDetail['id']) ? $pageDetail['id'] :''; ?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="last_name" name="last_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail['last_name']) ? $pageDetail['last_name'] : '';?>" />
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="zip_code" name="zip_code" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail['zip_code']) ? $pageDetail['zip_code'] : '';?>" />
                                            </div>    
                                        </div>
                                        <!-- <?php// if($key == 0) {?>
