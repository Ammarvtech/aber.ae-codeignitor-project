					...
					<div class="col-md-12">
						<table class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;"><?php echo $order->phone?></td>
                                <!-- <th class="headings">Discount Code</th>
                                <td><?php //echo $order->discount_code?></td> -->
                            </tr>
                            <tr>
						...
						<table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tbody>
                                ...
                                <tr class="odd pointer">
                                    ...
                                    <td class=" "><?php echo $user->modifier?></td>
                                    <td class=" ">$<?php echo $user->product_price?></td>
                                    <td class=" ">$<?php echo $user->modifier_price?></td>
                                ...
                                <tr>
                                    <td colspan="5" align="right"><b>Discount Amount</b></td>
