                                    ...
                                    <div id="<?php echo $v->name; ?>" class="tab-pane fade <?php if($key==0){ ?> in active <?php } ?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="name" name="name[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['name']) ? $pageDetail[$key]['name'] : '';?>" />
                                            </div>
                                        </div>
                                         <div class="item form-group">
