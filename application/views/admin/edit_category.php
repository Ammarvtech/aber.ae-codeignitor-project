                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <textarea name="description" class="form-control col-md-7 col-xs-12"><?php echo isset($mediaDetail['description']) ? $mediaDetail['description'] : '';?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <?php if(isset($mediaDetail['picture']) && $mediaDetail['picture']!=''){?>
                                        <div class="form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">&nbsp;</label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <a href="<?php echo base_url();?>uploads/data/<?php echo $mediaDetail['picture']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $mediaDetail['picture']?>" width="100px" height="100px" /></a>
                                                <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/category/deleteImage?id=<?php echo $mediaDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <input type="hidden" name="old_picture" id="old_picture" value="<?php echo $mediaDetail['picture']?>">
                                ...
                                <input name="picture" type="file" id="upload" class="hidden" onChange="">
                            </form>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/Category/uploadAddImage/"
                            });
