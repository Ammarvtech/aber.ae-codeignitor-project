                ...
                <div class="x_content content">
                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <select required="" name="type" class="form-control">
                                                    ...
                                                    <option value="residential" <?php if($productDetail['type'] == 'residential'){echo 'selected'; }?>>RESIDENTIAL</option>

                                                    <option value="commercial" <?php if($productDetail['type'] == 'commercial'){echo 'selected'; }?>>COMMERCIAL</option>
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type="hidden" name="pdf_file" id="pdf_file"  value="<?=$productDetail['pdf_file']?>" >
                                            ...
                                            <?php if(isset($productDetail['pdf_file']) && $productDetail['pdf_file']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['pdf_file']?>" class="group1" style="cursor:pointer">

                                                    <img src="<?php echo base_url();?>uploads/data/pdf.png" width="100px" height="100px" />

                                                    <br>

                                           

                                                         <?php echo $productDetail['pdf_file']?>                                                      

                                                        </a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=pdf_file" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete File</a></div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="hidden" name="image1" id="picture_name" value="<?=$productDetail['image1']?>">
                                            ...
                                            <?php if(isset($productDetail['image1']) && $productDetail['image1']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image1']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image1']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=image1" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                            ...
                                            <input type="hidden" name="image2" id="picture_name2" value="<?=$productDetail['image2']?>">

                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Detail Page Image <span>*Dimension Should be 1050*400</span>
                                            ...
                                            <?php if(isset($productDetail['image2']) && $productDetail['image2']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image2']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image2']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=image2" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="image3" id="picture_name3" value="<?=$productDetail['image3']?>">
                                            ...
                                            <?php if(isset($productDetail['image3']) && $productDetail['image3']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image3']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image3']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=image3" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="image4" id="picture_name4" value="<?=$productDetail['image4']?>">
                                            ...
                                            <?php if(isset($productDetail['image4']) && $productDetail['image4']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image4']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image4']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=image4" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="image5" id="picture_name5" value="<?=$productDetail['image5']?>">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <div id="myId5" class="dropzone" style="border: 1px solid #e5e5e5; height: 100px; "></div>
                                            ...
                                            <?php if(isset($productDetail['image5']) && $productDetail['image5']!=''){?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image5']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['image5']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/projects/deleteImage?id=<?php echo $productDetail['id'] ?>&name=image5" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                    ...
                    <div class="item form-group">                
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">                  
                                ...
                                <input type="text" class="form-control" id="locationTextField" name="pro_google_address" value="<?=$productDetail['pro_google_address'];?>" placeholder="Search Location" required="required" aria-required="true" autocomplete="off" aria-invalid="false" >  
                                ...
                                <input type="text" name="store_lng" id="pro_lng" value="<?=$productDetail['store_lng'];?>" class="form-control" placeholder="longitude">  
                                ...
                                <!-- <input type="hidden" name="store_lat" id="pro_lat" value="">      -->
                                 ...
                                 <input type="hidden" name="store_country" id="store_country" value="<?=$productDetail['store_country'];?>" >
