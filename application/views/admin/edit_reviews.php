                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea id="detail" name="details" class="form-control col-md-7 col-xs-12"><?php echo isset($sliderDetail['details']) ? $sliderDetail['details'] : '';?></textarea>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/reviews/uploadAddImage/"
                            });
