			...
			<!-- <div class="row top_tiles">
					<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="tile-stats">
							...
							<div class="count"><?php //echo $this->Users_model->totalCount();?></div>
					...
					<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="tile-stats">
							...
							<div class="count"><?php //echo $this->Users_model->totalorders();?></div>
							<h3>Total Orders</h3>
						</div>
					</div> 
					<div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="tile-stats">
							...
							<div class="count"><?php// echo $this->Users_model->totalincome();?></div>
							<h3>Total Income</h3>
						</div>
					</div>
				</div> -->
