                ...
                <div class="x_content content">
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Service Name <span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" id="service_name" name="service_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['service_name']) ? $sliderDetail['service_name'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/portfolio/uploadAddImage/"
                            });
