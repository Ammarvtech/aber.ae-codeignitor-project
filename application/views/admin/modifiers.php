            ...
            <div class="right_col" role="main">
                <div class="x_content content">
                    <div class="page-title">
                        ...
                        <div class="row">
                            <form id="import_frm" name="import_frm" method="post" action="<?php echo base_url() ?>admin/modifiers/import_modifiers">
                                <div class="col-md-3">
                                    <div id="branch">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <?php foreach ($detail as $d) { 
                               $modifiergroup = $this->Modifiergroup_model->getNameById($d->modifiergroup_id); 
                                $branch_name = $this->Location_model->getLocationById($d->branch_id);
                                ?>
                                <tr>
                                    <td><b><?php echo $d->name; ?></b></td>
                                    <td><b><?php echo $d->price; ?></b></td>
                                    <td><b><?php echo $modifiergroup->name; ?></b></td>
                                    <td><b><?php echo $branch_name ?></b></td>
                                    <td><a href="<?php echo base_url() ?>admin/modifiers/edit_modifier/<?php echo $d->id; ?>" class="btn btn-xs btn-default btn-falt"><i class="fa fa-edit"></i></a><a href="<?php echo base_url('admin/modifiers/delete_modifier') ?>/<?php echo $d->id; ?>" class="btn btn-xs btn-default btn-falt"><i class="fa fa-remove"></i></button></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
