                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/products/deleteImage?id=<?php echo $productDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                                </div>
                                            </div>
                                            <?php }?>
