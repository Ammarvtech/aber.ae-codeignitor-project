                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Picture Link <span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="picture_link" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['picture_link']) ? $sliderDetail['picture_link'] : '';?>" />
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/Follow/deleteSliderImage?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                </div>
                            </div>
                            <?php }?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/Follow/uploadAddImage/"
                            });
