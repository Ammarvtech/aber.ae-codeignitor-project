        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div class="x_content content">
                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail['title']) ? $pageDetail['title'] : '';?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Content <span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <textarea name="body" class="form-control col-md-7 col-xs-12"><?php echo isset($pageDetail['body']) ? $pageDetail['body'] : '';?></textarea>
                                            </div>
                                        </div>
                                ...
                                <label for="middle-name" class="control-label col-md-2 col-sm-2 col-xs-12">Type</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                  ...
                  <?php if(isset($pageDetail['image']) && $pageDetail['image']!=''){?>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">&nbsp;</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $pageDetail['image']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $pageDetail['image']?>" width="100px" height="100px" /></a>
                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/pages/deleteImage?id=<?php echo $pageDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                </div>
                            </div>
                            <?php }?>
                                    
                                <input type="hidden" name='page_id' value="<?php echo $pageDetail['id'] ?>">              
