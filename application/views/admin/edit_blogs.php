                ...
                <div class="x_content content">
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Tag <span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" id="tag" name="tag" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['tag']) ? $sliderDetail['tag'] : '';?>" />
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea id="details" name="details" class="form-control col-md-7 col-xs-12"><?php echo isset($sliderDetail['details']) ? $sliderDetail['details'] : '';?></textarea>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Author <span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" id="author" name="author" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['author']) ? $sliderDetail['author'] : '';?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="picture_name" id="picture_name">
                                <input type="hidden" name="old_picture" id="old_picture" value="<?php echo $sliderDetail['picture']?>">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">&nbsp;</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $sliderDetail['picture']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $sliderDetail['picture']?>" width="100px" height="100px" /></a>
                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/news/deleteImage?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                </div>
                            </div>
                            <?php }?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var myDropzone = new Dropzone(
                                ...
                                clickable: true,
                                maxFiles: 1,
                                url: "<?php echo base_url()?>admin/blogs/uploadAddImage/"
                            });
