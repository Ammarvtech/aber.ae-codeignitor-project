                            ...
                            <form name="frm">
                                ...
                                <div class="col-md-10 col-sm-5 col-xs-12 pull-right top_search">
                                    <div class="col-md-5 col-sm-5 col-xs-12 pull-right top_search">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Search Companies..." value="<?php echo ($this->input->get('name')) ?$this->input->get('name') : ''; ?>">
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tbody>
                                ...
                                <tr class="odd pointer">
                                    <td><?=$count;?></td>
                                    <td><?php if($product->company_logo!=''){?><img src="<?php echo base_url()?>uploads/data/<?php echo $product->company_logo;?>" width="100px" height="100px" /><?php }else{echo 'No Image';}?></td>
                                    ...
                                    <td class=" last" width="100">
                                        <a href="<?php echo base_url()?>admin/companies/editCompany/<?php echo $product->id?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
    									<a href="<?php echo base_url()?>admin/companies/deleteCompany?id=<?php echo $product->id?>" onClick="return confirm('Are you sure to delete this product ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a>
                                    </td>
                                </tr>
                                <?php $count++; }?>
                            </tbody>
