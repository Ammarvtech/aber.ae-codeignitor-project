                        ...
                        <div class="x_panel">
                            ...
                            <form method="post" name="frm" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <textarea name="description" class="form-control col-md-7 col-xs-12"><?php echo isset($sliderDetail['description']) ? $sliderDetail['description'] : '';?></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">button Text <span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="button_text" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['button_text']) ? $sliderDetail['button_text'] : '';?>" />
                                            </div>
                                        </div>
                                        
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">button Link<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="link" name="link" class="form-control col-md-7 col-xs-12" value="<?php echo isset($sliderDetail['link']) ? $sliderDetail['link'] : '';?>" />
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $sliderDetail['picture'] ? $sliderDetail['picture'] :''; ?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $sliderDetail['picture']?>" width="100px" height="100px" /></a>
                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/News/deleteSliderImage?id=<?php echo $sliderDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                </div>
                            </div>
                            <?php }?>
