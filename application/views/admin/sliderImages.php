                                                ...
                                                <div class="image view view-first">
                                                    ...
                                                    <div class="mask">
                                                        ...
                                                        <div class="tools tools-bottom">                                                            
                                                            <a href="<?php echo base_url()?>admin/sliderimages/delete/<?php echo $row->id?>" onClick="return confirm('Are you sure to delete this image ?')"><i class="fa fa-times"></i></a>
                                                            <a href="<?php echo base_url()?>admin/sliderimages/edit/<?php echo $row->id?>"><i class="fa fa-pencil"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="caption">
