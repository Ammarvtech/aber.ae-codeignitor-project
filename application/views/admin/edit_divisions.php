                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <select required="" name="category" class="form-control">
                                                    ...
                                                    <option value="investment" <?php if($productDetail['category'] == 'investment'){echo 'selected'; }?>>Investment</option>

                                                    <option value="property" <?php if($productDetail['category'] == 'property'){echo 'selected'; }?>>Property</option>

                                                    <option value="lifestyle" <?php if($productDetail['category'] == 'lifestyle'){echo 'selected'; }?>>Lifestyle</option>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <input type="text" name="product_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['product_name']) ? $productDetail['product_name'] : '';?>" />
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Site Link<span class="required">*</span>

                                            </label>

                                            <div class="col-md-7 col-sm-7 col-xs-12">

                                                <input type="text" name="site_link"  class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['site_link']) ? $productDetail['site_link'] : '';?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if(isset($productDetail['picture']) && $productDetail['picture']!=''){?>
                                                value="<?=$productDetail['picture']?>"
                                                <?}?>
                                            >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <a href="<?php echo base_url();?>uploads/data/<?php echo $productDetail['picture']?>" class="group1"><img src="<?php echo base_url();?>uploads/data/<?php echo $productDetail['picture']?>" width="100px" height="100px" /></a>

                                                    <div style="margin-top:5px;"><a href="<?php echo base_url()?>admin/divisions/deleteImage?id=<?php echo $productDetail['id'] ?>" onClick="return confirm('Are you sure to delete this picture?')"><i class="fa fa-trash"></i>&nbsp;Delete Image</a></div>
                                            ...
                                            <input type="hidden" name="old_picture" id="old_picture" value="<?php echo $productDetail['picture']?>">
