                            ...
                            <form method="post" name="frm" action="" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="company_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['company_name']) ? $productDetail['company_name'] : '';?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">URL (Website Link)<span class="required">*</span>
                                            </label>
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" name="url"  class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['url']) ? $productDetail['url'] : '';?>" />
                                            </div>
                                        </div>
                            
                      
                                        <div class="form-group">
                                            <input type="hidden" name="company_logo" id="picture_name">
