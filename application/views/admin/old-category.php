                            ...
                            <tr class="odd pointer">
                                ...
                                <td><?php echo date('d/m/Y', strtotime($m->date_created)); ?></td>
                                 <td class=" last" width="100" nowrap>
                                    ...
                                    <a href="<?php echo base_url()?>admin/Category/delete?id=<?php echo $m->id?>" onClick="return confirm('Are you sure to delete this ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
