                            ...
                            <form method="post" name="frm" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                ...
                                                <textarea name="description" class="form-control col-md-7 col-xs-12" required="required"><?php echo isset($productDetail['description']) ? $productDetail['description'] : '';?></textarea>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="site_link">Site Link<span class="required">*</span>

                                            </label>

                                            <div class="col-md-7 col-sm-7 col-xs-12">

                                                <input required="required" type="url" name="site_link"  class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['site_link']) ? $productDetail['site_link'] : '';?>" />
