                                    ...
                                    <div id="<?php echo $v->name; ?>" class="tab-pane fade <?php if($key==0){ ?> in active <?php } ?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="name" name="name[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($productDetail['name'][$key]) ? $productDetail['name'][$key] : '';?>" />
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="adress" name="adress[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['adress']) ? $pageDetail[$key]['adress'] : '';?>" />
                                            </div>    
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="phone" name="phone[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['phone']) ? $pageDetail[$key]['phone'] : '';?>" />
                                            </div>    
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="email" id="email" name="email[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['email']) ? $pageDetail[$key]['email'] : '';?>" />
                                            </div>    
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="latitue" name="latitue[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['latitue']) ? $pageDetail[$key]['latitue'] : '';?>" />
                                            </div>    
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-12">
                                                <input type="text" id="longitude" name="longitude[]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo isset($pageDetail[$key]['longitude']) ? $pageDetail[$key]['longitude'] : '';?>" />
                                            </div>    
                                        </div>
